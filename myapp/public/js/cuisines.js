...
// main部分开始
// 1. main-header 的跳转
var mainHeader = document.querySelectorAll('.main-header>li')
var mainContainer = document.querySelectorAll('.main-container')
mainHeader[0].style.color = '#ff6767'

mainHeader[0].onclick = function(){
...
mainHeader[1].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[1].style.color = '#ff6767'
...
mainHeader[2].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[2].style.color = '#ff6767'
...
mainHeader[3].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[3].style.color = '#ff6767'
...
mainHeader[4].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[4].style.color = '#ff6767'
  
  mainContainer.forEach((item)=>{
    item.style.display = 'none'
  })
  mainContainer[4].style.display = 'block'
}

mainHeader[5].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[5].style.color = '#ff6767'
  
  mainContainer.forEach((item)=>{
    item.style.display = 'none'
  })
  mainContainer[5].style.display = 'block'
}

mainHeader[6].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[6].style.color = '#ff6767'
  
  mainContainer.forEach((item)=>{
    item.style.display = 'none'
  })
  mainContainer[6].style.display = 'block'
}

mainHeader[7].onclick = function(){
  mainHeader.forEach((item)=>{
    item.style.color = '#6b7280'
  })
  mainHeader[7].style.color = '#ff6767'
  
  mainContainer.forEach((item)=>{
    item.style.display = 'none'
  })
  mainContainer[7].style.display = 'block'
}
